...
```{r}
#| label: tbl-rf-basic
#| tbl-cap: "Basic Random Forest Best Hyperparamaters"
#| echo: false
...
```{r}
#| label: tbl-knn-basic
#| tbl-cap: "Basic KNN Best Hyperparamaters"
#| echo: false
...
```{r}
#| label: tbl-bt-basic
#| tbl-cap: "Basic Boostd Trees Best Hyperparamaters"
#| echo: false
...
```{r}
#| label: tbl-en-basic
#| tbl-cap: "Basic Elastic Net Best Hyperparamaters"
#| echo: false
...
:::
Elastic Net's best hyperparamaters are a `mixture` of 1 and a `penalty` of 0.5, which is a Lasso model. 
