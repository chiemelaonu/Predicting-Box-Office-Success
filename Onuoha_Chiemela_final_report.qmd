...
<br>  
The parameters I will be tuning are `min_n` with a range of 2-40, `mtry` with a range of 1-10, `learn_rate` with a range of -5 to -0.2, and a `tree_depth` range of 6 to 10.
...
<br>  
The parameter I will be tuning is `neighbors`.  
<br>  
